...
<title>nondetecionLogin Page</title>
...
<div align="center">
<form name ="form" method ="post" action="nondetectionLogin.jsp" onSubmit="return ValidateLoginForm(this)">
<p>Username:
...
if(request.getParameter("login")!=null){
	...
	if(rs.next()){
		...
		out.print("<script>alert('Wrong password!');window.location='nondetectionLogin.jsp';</script>");
	}	
